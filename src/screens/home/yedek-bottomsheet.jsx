...
const BottomSheetMenu = ({ initialIndex = 1 }) => {
    ...
    const { services, selected, selectService, loading } = useServices();
            ...
            <View style={styles.sectionContainer}>
                {loading ? (
                    <View style={{ paddingVertical: vs(40), alignItems: 'center' }}>
                        ...
                        <Text style={{ marginTop: vs(12), color: Colors.gray, fontSize: fs(14) }}>Hizmetler yükleniyor...</Text>
                    </View>
                ) : (
    ...
    const renderPlanningContent = () => {
        ...
        return (
            <View style={{ paddingHorizontal: 20, paddingBottom: 40 }}>
                ...
                {selected && (
                    <View style={{ marginBottom: 15, padding: 10, backgroundColor: Colors.secondary, borderRadius: 12, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: Colors.border }}>
                        <Image
                        ...
                        />
                        <View style={{ flex: 1 }}>
                            <Text style={{ fontSize: 16, fontWeight: '700', color: Colors.white }}>{selected?.title || selected?.name || 'Hizmet Seçilmedi'}</Text>
                            {selected?.description ? (
                                <Text style={{ fontSize: 12, color: Colors.gray }} numberOfLines={1}>{selected.description}</Text>
                            ) : null}
                        </View>
                ...
                <BottomSheetScrollView contentContainerStyle={{ paddingHorizontal: s(16), paddingBottom: vs(120) }}>
                    ...
                    <View style={styles.sectionCard}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Text style={{ fontSize: 14, fontWeight: '700', color: Colors.white, flex: 1 }} numberOfLines={1}>{pickup?.address}</Text>
                        ...
                        {stops.filter((s) => !!s.location).map((stop) => (
                            <View key={stop.id} style={{ flexDirection: 'row', marginTop: vs(8) }}>
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        <Text style={{ fontSize: 14, fontWeight: '700', color: Colors.white, flex: 1 }} numberOfLines={1}>{stop?.address}</Text>
                                        <TouchableOpacity onPress={() => setMode('planning')}><Text style={styles.changeMuted}>Değiştir</Text></TouchableOpacity>
                                    </View>
                                </View>
                            </View>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: vs(8) }}>
                            ...
                            <View style={{ flex: 1 }}>
                                <Text style={{ color: Colors.primary, fontSize: 12, fontWeight: 'bold', marginBottom: 4 }}>Varış noktası</Text>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Text style={{ fontSize: 14, fontWeight: '700', color: Colors.white, flex: 1 }} numberOfLines={1}>{dropoff?.address}</Text>
                                    <TouchableOpacity onPress={() => setMode('planning')}><Text style={styles.changeMuted}>Değiştir</Text></TouchableOpacity>
                                </View>
                            </View>
                        </View>
                    ...
                    >
                        <View style={{ flex: 1, marginLeft: s(12) }}>
                            <Text style={{ fontSize: fs(16), color: emergencyError ? Colors.red : Colors.white }}>
...
const styles = StyleSheet.create({
    ...
    handleBar: { width: s(48), height: vs(5), borderRadius: ms(3), backgroundColor: Colors.lightGray, marginBottom: vs(8) },
    headerTitle: { fontSize: fs(18), fontWeight: '700', color: Colors.white },
    ...
    locationInfo: { flex: 1 },
    label: { fontSize: fs(12), color: Colors.gray, fontWeight: '600', marginBottom: vs(2), textTransform: 'uppercase', letterSpacing: 0.5 },
    addressRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    addressText: { fontSize: fs(14), fontWeight: '700', color: Colors.white, flex: 1, marginRight: s(12) },
    ...
    serviceChip: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.secondary, paddingVertical: vs(8), paddingHorizontal: s(12), borderRadius: ms(20) },
    serviceChipActive: { backgroundColor: Colors.primary, borderColor: Colors.primary },
    serviceChipText: { marginLeft: s(6), fontSize: fs(13), color: Colors.white, fontWeight: '600' },
    serviceChipTextActive: { color: Colors.black },
    ...
    serviceCardActive: { borderColor: Colors.primary, backgroundColor: Colors.secondary },
    ...
    actionRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: vs(12), paddingHorizontal: vs(16), borderBottomWidth: 1, borderBottomColor: Colors.border },
    actionRowLeft: { flexDirection: 'row', alignItems: 'center' },
    actionRowText: { fontSize: fs(13), fontWeight: '700', color: Colors.white, marginLeft: s(10) },
    actionRowTextLarge: { fontSize: fs(16), fontWeight: '700', color: Colors.white, marginLeft: s(10) },
    actionRowValue: { fontSize: fs(14), fontWeight: '700', color: Colors.white, marginRight: s(8) },
    confirmButton: {
        backgroundColor: Colors.primary, paddingVertical: vs(10),
        height: ms(50), alignItems: 'center', marginBottom: vs(10), marginTop: vs(50), justifyContent: 'center'
    },
    confirmButtonDisabled: { opacity: 0.5 },
    confirmButtonText: { color: Colors.black, fontSize: fs(15), fontWeight: '700' },
    loadingOverlay: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.75)', alignItems: 'center', justifyContent: 'center' },
    loadingOverlayText: { marginTop: vs(8), color: Colors.white, fontSize: fs(14), fontWeight: '700' },
    ...
    timeValuePillText: { fontSize: fs(13), fontWeight: '700', color: Colors.white, marginRight: s(6) },
    ...
    optionText: { flex: 1, fontSize: fs(16), color: Colors.white, marginLeft: s(12) },
    termsRow: { flexDirection: 'row', alignItems: 'flex-start', paddingVertical: vs(12) },
    checkbox: { width: s(20), height: s(20), borderRadius: s(4), backgroundColor: Colors.primary, marginRight: s(12), alignItems: 'center', justifyContent: 'center' },
    termsText: { flex: 1, color: Colors.white },
    bottomBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: vs(12) },
    bottomBarFixed: { position: 'absolute', left: s(16), right: s(16), bottom: vs(10), backgroundColor: Colors.secondary, padding: s(10), borderRadius: ms(16) },
    bottomPrice: { fontSize: fs(18), fontWeight: '800', color: Colors.white },
    ...
    modalCard: { backgroundColor: Colors.background, borderTopLeftRadius: ms(24), borderTopRightRadius: ms(24), padding: s(16), maxHeight: '75%' }
    ,
    linkText: { color: Colors.primary, textDecorationLine: 'underline', fontWeight: '700', fontSize: fs(13) }
    ,
    webContainer: { flex: 1, backgroundColor: Colors.background },
    webHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: s(16), paddingVertical: vs(12), borderBottomWidth: 1, borderBottomColor: Colors.border },
    webBack: { paddingRight: s(12), paddingVertical: vs(4) },
    webTitle: { fontSize: fs(16), fontWeight: '700', color: Colors.white, flex: 1 },
    webLoading: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.background },
    webLoadingText: { marginTop: vs(8), color: Colors.gray, fontSize: fs(13) },
    summaryCard: { backgroundColor: Colors.secondary, borderRadius: ms(16), padding: s(16), borderWidth: 1, borderColor: Colors.border, marginBottom: vs(12), shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: ms(6), shadowOffset: { width: 0, height: 3 }, elevation: 3 },
    sectionCard: { backgroundColor: Colors.secondary, borderRadius: ms(16), padding: s(16), borderWidth: 1, borderColor: Colors.border, marginBottom: vs(12) },
    summaryLabel: { fontSize: fs(13), color: Colors.gray, fontWeight: '600' },
    summaryValue: { fontSize: fs(14), color: Colors.white, fontWeight: '800' },
    summaryService: { fontSize: fs(12), color: Colors.gray, fontWeight: '700' },
    summaryPricing: { fontSize: fs(12), color: Colors.white, fontWeight: '700' },
    contactItem: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    contactName: { fontSize: fs(14), fontWeight: '700', color: Colors.white },
    contactPhone: { fontSize: fs(12), color: Colors.gray, marginTop: vs(2) },
    addNewContactBtn: {
        flexDirection: 'row',
        alignItems: 'center',
        justifyContent: 'center',
