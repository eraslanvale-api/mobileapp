...
const styles = StyleSheet.create({
  ...
  label: { fontSize: fs(14), color: Colors.gray, fontWeight: '700', marginBottom: vs(6) },
  inputWrapper: { borderWidth: 1, borderColor: Colors.border, paddingHorizontal: s(12), paddingVertical: vs(8), backgroundColor: Colors.secondary, borderRadius: 8 },
